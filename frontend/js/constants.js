const contractAddress = "0xCF0425158855762B62d9868ee572949b7f0Bdf56"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Nut Head Community!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Nut Heads Community NFT Project is a decentralized, open-source project that aims to be a game changer in the NFT and crypto world, while making a difference around us.';
